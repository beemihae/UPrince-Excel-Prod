        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "#btnSignIn", function () {
                if ((navigator.userAgent.indexOf('iPad') != -1) /*|| !(Office.context.requirements.isSetSupported('HtmlCoercion'))*/) { //iPad
                    var child = window.open("https://plaza.uprince.com/oauth2/authorize?client_id=thoa4iaGh9aidei8aeb9AiyeesohghaicieGipua6jie1Sai6AiquiegheiZowah&scope=profile&state=CSFR&response_type=token&redirect_uri=https%3A%2F%2Fuprinceexcelprod.azurewebsites.net%2F1.1%2Fhome%2home.html", "");
        ...
        $.ajax({
          ...
          .done(function (str) {
              if (str.success) {
                  ...
                  window.location.href = "https://uprinceexcelprod.azurewebsites.net/addin/home/home.html"
